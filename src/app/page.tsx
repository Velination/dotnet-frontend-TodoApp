  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        'https://dotnet-backend-todoapp.onrender.com/api/auth/signup',
        {
          method: 'POST',
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        'https://dotnet-backend-todoapp.onrender.com/api/Auth/login',
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
              ...
              <div className="w-full max-w-md">
                ...
                <p className="text-center text-sm text-gray-600 mt-4">
                  ...
                  <button
                    ...
                    className="hover:bg-red-500 hover:text-white hover:p-1 hover:rounded-sm"
                  >
                    Login
                  </button>
                </p>
              ...
              <div className="w-full max-w-md">
                ...
                <p className="mt-6 text-sm">
                  ...
                  <button
                    ...
                    className="hover:bg-green-800 hover:text-white hover:p-1 hover:rounded-sm"
                  >
                    Sign Up
                  </button>
                </p>
